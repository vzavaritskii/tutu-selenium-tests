...
```
id:             NAV_BTN_BEH_008
Цель:           Убедиться, что при нажатии на кнопку "Джарвел" открывается модальное окно
Предусловия:    Пользователь не авторизован
                Очищены cookies и локальное хранилище
                Браузер открыт в десктопной версии
Шаги:           1. Открыть главную страницу сайта https://www.tutu.ru
...
Ож. результат:  1. Не происходит перехода на новую страницу
                2. Открывается модальное окно чата с Джарвел
```
...
```
id:             NAV_BTN_BEH_009
Цель:           Убедиться, что после закрытия модального окна с "Джарвел" кнопка остается без выделения
Предусловия:    Пользователь не авторизован
                Очищены cookies и локальное хранилище
                Браузер открыт в десктопной версии
Шаги:           1. Открыть главную страницу сайта https://www.tutu.ru
...
Ож. результат:  1. Не происходит перехода на новую страницу
                2. Открывается модальное окно чата с Джарвел
Шаги2:          1. Кликнуть вне модального окна с Джарвел
Ож. результат:  1. Происходит закрытие модального окна
                2. Кнопка "Джарвел" остается без выделения
```